...
const JatengSection = styled.section`
  padding: 100px 20px;
...
const jatengDestinasiData = [
  { id: 1, image: 'img/dieng.jpg', title: 'Wisata Dieng', duration: '1 Hari', location: 'Wonosobo, Indonesia', price: 'Rp 300.000', region: 'jawa_tengah' },
    { id: 2, image: 'img/borobudur.jpg', title: 'Candi Borobudur', duration: '1 Hari', location: 'Magelang, Indonesia', price: 'Rp 400.000', region: 'jawa_tengah' },
];

const DestinasiJateng = () => {
  ...
  return (
    <JatengSection>
      <SectionTitle>Destinasi di Jawa Tengah</SectionTitle>
      <CardsContainer>
        {jatengDestinasiData.map((destinasi) => (
...
export default DestinasiJateng;
