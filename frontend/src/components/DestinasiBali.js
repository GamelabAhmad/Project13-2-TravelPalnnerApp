...
const BaliSection = styled.section`
  padding: 100px 20px;
...
const baliDestinasiData = [
  { id: 1, image: 'img/kelingking.jpg', title: 'Kelingking Beach', duration: '2 Hari', location: 'Nusa Penida Bali, Indonesia', price: 'Rp 1.200.000' },
  { id: 2, image: 'img/Pantai-Kuta.jpg', title: 'Kuta Beach', duration: '2 Hari', location: 'Nusa Penida Bali, Indonesia', price: 'Rp 800.000' },
];
...
const DestinasiBali = () => {
  ...
  return (
    <BaliSection>
      <SectionTitle>Destinasi di Bali</SectionTitle>
      <CardsContainer>
        {baliDestinasiData.map((destinasi) => (
