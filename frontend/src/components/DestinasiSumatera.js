...
const SumateraSection = styled.section`
  padding: 100px 20px;
...
const sumateraDestinasiData = [
    { id: 1, image: 'img/danau-toba.jpg', title: 'Danau Toba', duration: '2 Hari', location: 'Sumatera Utara, Indonesia', price: 'Rp 1.000.000', region: 'sumatera' },
];

const DestinasiSumatera = () => {
  ...
  return (
    <SumateraSection>
      <SectionTitle>Destinasi di Sumatera</SectionTitle>
      <CardsContainer>
        {sumateraDestinasiData.map((destinasi) => (
...
export default DestinasiSumatera;
