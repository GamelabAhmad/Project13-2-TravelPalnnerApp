...
const YogyakartaSection = styled.section`
  padding: 100px 20px;
...
const yogyakartaDestinasiData = [
    { id: 1, image: 'img/Gambar-Trip1.jpeg', title: 'Pantai Gunungkidul', duration: '1 Hari', location: 'Yogyakarta, Indonesia', price: 'Rp 300.000', region: 'yogyakarta' },
  
];

const DestinasiYogyakarta = () => {
  ...
  return (
    <YogyakartaSection>
      <SectionTitle>Destinasi di Yogyakarta</SectionTitle>
      <CardsContainer>
        {yogyakartaDestinasiData.map((destinasi) => (
...
export default DestinasiYogyakarta;
