...
const JatimSection = styled.section`
  padding: 100px 20px;
...
const jatimDestinasiData = [
    { id: 1, image: 'img/bromo.jpg', title: 'Gunung Bromo', duration: '1 Hari', location: 'Bromo, Indonesia', price: 'Rp 350.000', region: 'jawa_timur' },
    { id: 2, image: 'img/kawah-ijen.jpg', title: 'Kawah Ijen', duration: '2 Hari', location: 'Banyuwangi, Indonesia', price: 'Rp 1.200.000', region: 'jawa_timur' },
];

const DestinasiJatim = () => {
  ...
  return (
    <JatimSection>
      <SectionTitle>Destinasi di Jawa Timur</SectionTitle>
      <CardsContainer>
        {jatimDestinasiData.map((destinasi) => (
