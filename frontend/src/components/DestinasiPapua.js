...
const PapuaSection = styled.section`
  padding: 100px 20px;
...
const DestinasiPapua = () => {
  ...
  return (
    <PapuaSection>
      <SectionTitle>Destinasi di Papua</SectionTitle>
      <CardsContainer>
        {papuaDestinasiData.map((destinasi) => (
